...
{
while(true)	{
	if(TSreadState(downTouch) == 0 && TSreadState(upTouch) == 0) {
	...
	if(TSreadState(downTouch) == 1  && TSreadState(upTouch) == 0) {
		if(nNxtButtonPressed == 1)
		{
			motor[Scissor] = 50;
		}
	...
	if(TSreadState(downTouch) == 0  && TSreadState(upTouch) == 1) {
		if(nNxtButtonPressed == 1)
		{
			motor[Scissor] = 0;
		}
	...
	{
		while(TSreadState(downTouch) == 0 && nNxtButtonPressed != 1 && nNxtButtonPressed != 2 )
		{
			motor[Scissor] = -50;
		}
			motor[Scissor] = 0;
