...
task main()
{
  ...
  while(HTIRS2readACDir(irsensor) < 4 && nMotorEncoder[RightDrive] < 4*360*4.4){
	...
	// STEP 3: Go backwards until encoder=0
	 while(nMotorEncoder[RightDrive] < 11000){
	...
	while(true)
	{
		...
		//wait1Msec(10);
		if (currHeading <= 315.0 && currHeading > 310.0) break;
	...
	while(true)
	{
		nxtDisplayCenteredTextLine(3, "Heading: %d", currHeading);
		//wait1Msec(10);
		if (currHeading >= 80.0 && currHeading < 90.0) break;
