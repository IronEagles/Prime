...
task main()
{
  ...
  int dirIR2 = 0;
	...
	int dcS1_3, dcS2_3, dcS3_3, dcS4_3, dcS5_3 = 0;
...
//  int dirEnh2, strEnh2;
  ...
  ///////////////////////////////////////////////////////////
  	...
  	nMotorEncoder[ArmMotor] = 0 ;
				...
				while(1==1){//dirIR1 = HTIRS2readACDir(IRCenter);
				HTIRS2readAllACStrength(IRCenter, dcS1_3, dcS2_3, dcS3_3, dcS4_3, dcS5_3 );
				...
				nxtDisplayTextLine(5, "%d,%d,%d,%d,%d", dcS1_1, dcS2_1, dcS3_1, dcS4_1, dcS5_1);
				nxtDisplayTextLine(6, "%d,%d,%d,%d,%d", dcS1_2, dcS2_2, dcS3_2, dcS4_2, dcS5_2);
				nxtDisplayTextLine(7, "%d,%d,%d,%d,%d", dcS1_3, dcS2_3, dcS3_3, dcS4_3, dcS5_3);
				}
