...
task main()
{
  ...
  ///////////////////////////////////////////////////////////
  	...
  	nMotorEncoder[ArmMotor] = 0 ;
    	...
    	count = 0;
    	motor[ArmMotor] = -60;
    	while (nMotorEncoder[ArmMotor] > -(168*4*9))
    	{
      ...
      nxtDisplayTextLine(1, "%d", nMotorEncoder[ArmMotor]);
    	...
    	count = 0;
    	while (nMotorEncoder[LeftDrive] < (1440 * 1.8))  // wait for motor to reach a specific location
			{
  	...
  	nxtDisplayTextLine(2, "%d - %d", nMotorEncoder[LeftDrive], nMotorEncoder[RightDrive]);
    	...
    	count = 0;
			while (nMotorEncoder[RightDrive] < (1440 * 0.5))  // wait for motor to reach a specific location
					{
				if(count++ > 150){break;}
				wait10Msec(1);
					}
