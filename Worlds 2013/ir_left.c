  ...
  ///////////////////////////////////////////////////////////
  	...
  	nMotorEncoder[ArmMotor] = 0 ;
  	 ...
  	 wristPos = ServoValue[Wrist];
    	...
    	motor[RightDrive] = 31;
    	motor[LeftDrive] = 30;
    	while(nMotorEncoder[RightDrive] < (1440))
    	{
    		wait1Msec(10);
    		if(count++ > 500){break;}
    	}
      ...
      nxtDisplayTextLine(1, "%d", nMotorEncoder[ArmMotor]);
    	...
    	motor[RightDrive] = 0;
			...
			//Set wrist position
			servoTarget[Wrist] = 130;
      servoTarget[RightWrist] = 125;
      ...
      nMotorEncoder[LeftDrive] = 0 ;
  	 ...
  	 wait1Msec(500);
    	...
    	count = 0;
    	while (nMotorEncoder[LeftDrive] > (1440 * -0.35))  // wait for motor to reach a specific location
			{
  	...
  	nxtDisplayTextLine(2, "%d - %d", nMotorEncoder[LeftDrive], nMotorEncoder[RightDrive]);
		...
		//Turn until directions are equal.
    	count = 0;
    	irsearch=1;
    	...
    	PlayTone(880, 15);
		    ...
		    nxtDisplayTextLine(6, "%d,%d,%d,%d,%d", dcS1_1, dcS2_1, dcS3_1, dcS4_1, dcS5_1);
				...
				//If Both the same, straight
				//If Sensor 1 is less than 2, Turn left
				//If Sensor1 is greater than 2, turn right
				...
				if (dcS3_1>20 && dcS4_1>20 && dcS3_2>20 && dcS2_2>20){
					motor[LeftDrive] = 0;
    			motor[RightDrive] = 0;
					irsearch=0;
					break;
   ...
   // 	count = 0;
   // 	while (nMotorEncoder[LeftDrive] > (1440 * -0.001))  // wait for motor to reach a specific location
			//{
   ...
   // 	motor[RightDrive] = 0;
	...
	//Go forward until the IR reads that we're close
  	 ...
  	 wait1Msec(500);
    	...
    	count = 0;
    	while (nMotorEncoder[LeftDrive] < (1440 * 0.05))  // wait for motor to reach a specific location
			{
